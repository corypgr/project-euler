...
public class ProblemSolutionTest {
    ...
    static Stream<Arguments> problemAndExpectedSolution() {
        return Stream.of(
                ...
                arguments(new PE0028(), 669171001),
                ...
                arguments(new PE0052(), 142857),
                arguments(new PE0053(), 4075),
                arguments(new PE0054(), 376L),
                arguments(new PE0055(), 249L),
                arguments(new PE0056(), 972),
                arguments(new PE0057(), 153),
                arguments(new PE0058(), 26241),
                arguments(new PE0059(), 129448),
                arguments(new PE0060(), 26033L),
                arguments(new PE0061(), 28684),
                arguments(new PE0062(), 127035954683L),
                arguments(new PE0063(), 49),
                arguments(new PE0064(), 1322L),
                arguments(new PE0065(), 272),
                arguments(new PE0066(), 661),
                arguments(new PE0067(), 7273L),
                arguments(new PE0068(), 6531031914842725L),
                arguments(new PE0069(), 510510),
                arguments(new PE0070(), 8319823L),
                arguments(new PE0071(), 428570),
                arguments(new PE0072(), 303963552391L),
                arguments(new PE0073(), 7295372L),
                arguments(new PE0074(), 402L),
                arguments(new PE0075(), 161667L));
    }
}
